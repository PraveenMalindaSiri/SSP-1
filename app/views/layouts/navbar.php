    ...
    <header class="bg-gray-800 text-white pr-10 pl-10 pt-4 pb-4">
        <nav class="flex justify-between items-center mx-auto w-[90%]">
            ...
            <div class="flex items-center gap-10">
                <a href="../shared/manageprofile.php"><img src="/cb008920/public/assets/images/main/avatar-white.png" alt="profile" class="w-10 h-10 hover:-translate-y-1 transition ease-in-out delay-75"></a>
