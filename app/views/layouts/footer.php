<footer>
    <div class="footer-container bg-gray-800 text-white pr-10 pl-10 pt-4 pb-1 mt-5">
        <section>
            ...
            <a href="/cb008920/physicalproducts" class="text-lg text-cyan-400 hover:text-white">See all games...</a>
        </section>
        <div class="flex justify-between flex-col md:flex-row items-center mt-4 pr-10 pl-10 gap-4">
            <a href="/cb008920/about" class="text-xl text-cyan-400 hover:text-white">About Us</a>
            <section class="flex md:flex-row items-center gap-10">
                ...
                <a href="https://www.youtube.com/" target="_blank"><img src="/cb008920/public/assets/images/main/youtube.png"
                        alt="youtube" class="w-7 h-7 transition ease-in-out delay-150 hover:-translate-y-1"></a>
                <a href="https://www.instagram.com/" target="_blank"><img
                        src="/cb008920/public/assets/images/main/instagram.png" alt="instagram" class="w-7 h-7 transition ease-in-out delay-100 hover:-translate-y-1"></a>
            </section>
        </div>
        <p class="text-center pt-2">Copyrights &copy; All Rights Reserved.</p>
    </div>
</footer>